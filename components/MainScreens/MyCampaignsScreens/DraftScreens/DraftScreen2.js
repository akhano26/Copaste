...
<View style={{marginTop:'12%',}}>
  ...
  return (
   ...
   <View style={styles.btn_con}>
    <TouchableOpacity style={styles.single_btn}><Text style={{color:'#433FF1',fontFamily:'Poppins-Medium'}}>CANCEL</Text></TouchableOpacity>
    <TouchableOpacity style={styles.Stats_btn}>
      <Text style={{color:'#fff',fontFamily:'Poppins-Medium'}}>Statistics</Text>
      <Image source={require('../../../../assets/Stats_pic.png')} style={{width:responsiveWidth(5),height:responsiveHeight(1.6)}}/>
      </TouchableOpacity>
    <TouchableOpacity style={styles.single_btn}><Text style={{color:'#433FF1',fontFamily:'Poppins-Medium'}}>NEXT</Text></TouchableOpacity>
   </View>
