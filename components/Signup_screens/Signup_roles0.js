...
function SignupRoles0({navigation}) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.sec_container}>
        ...
        <View style={styles.boxContiner}>
          ...
          <Text style={{color:isGirlenemy?'#6061F6':'#0E0E17',}}>I'm a Copaster</Text>
          <Text style={{color:isGirlenemy?'#6061F6':'#0E0E17',textAlign:'center'}}>I advertise products on network</Text></TouchableOpacity>
          ...
          <Text style={{color:isBoyenemy?'#6061F6':'#0E0E17'}}>I'm a Advertiser</Text>
          <Text style={{color:isBoyenemy?'#6061F6':'#0E0E17',textAlign:'center'}}>I want to advertise my product</Text></TouchableOpacity>
        </View>
        <View style={{flex:1}}>
        ...
        <View style={{flexDirection:'row',justifyContent:'center', flex: 0.5,marginTop:'5%' }}>
